...
namespace FC_MST
{
    public partial class XtraFormMain : Form
    {
        ...
        private void tạoAgentToolStripMenuItem_Click(object sender, EventArgs e)
        {
            AddNewAgent form = new AddNewAgent();
            NhungForm(form);
        }

        private void cậpNhậtTrạngTháiAgentToolStripMenuItem_Click(object sender, EventArgs e)
        {
            ActivateAgentForm form = new ActivateAgentForm();
            NhungForm(form);
        }
    }
}
